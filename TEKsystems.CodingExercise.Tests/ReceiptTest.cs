...
namespace TEKsystems.CodingExercise.Tests
{
    ...
    public class ReceiptTest
    {
        ...
        public void ShouldCreateReceiptForBasket2()
        {
            ...
            var perfume = new Perfume { Id = 5, Name = "bottle of perfume", Price = 47.5m, ProductOrigin = EProductOrigin.Imported };
        ...
        {
            var importedPerfume = new Perfume { Id = 6, Name = "bottle of perfume", Price = 27.99m, ProductOrigin = EProductOrigin.Imported };
            ...
            var chocolates = new Food { Id = 9, Name = "box of chocolates", Price = 11.25m, ProductOrigin = EProductOrigin.Imported };
